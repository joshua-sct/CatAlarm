...
# BASED ON c:\Users\tungsten\STM32CubeIDE\workspace_1.14.1\CatAlarm
...
target_compile_definitions(
    ...
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:CXX>>:STM32G030xx>"
    ...
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:CXX>>:STM32G030xx>"
)
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mcpu=cortex-m0plus>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32G030K8TX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32G030K8TX_FLASH.ld>"
)
